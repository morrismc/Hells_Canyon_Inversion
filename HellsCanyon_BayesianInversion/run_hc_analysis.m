...
ksn_file = 'C:\Users\mmorriss\Desktop\Side_projects\Hells_Canyon_Inversion\ksnTable.xlsx';  % <-- UPDATE: e.g., 'C:\Users\...\ksnTable.xlsx'

% Path to DEM (.mat or .tif)
dem_file = 'C:\Users\mmorriss\Desktop\Side_projects\Hells_Canyon_Inversion\Granite_crk\Basin_80_Data.mat';  % <-- UPDATE: e.g., 'C:\Users\...\Basin_80_Data.mat'
...
cave_data = struct();
cave_data.ages      = [1.5e6, 2.71e6, 5.5e6];  % years before present
cave_data.heights   = [242,   343,   375];      % meters above river
cave_data.age_err   = [0.73e6, 1.4e6, 3.8e6];   % 1-sigma age uncertainty
